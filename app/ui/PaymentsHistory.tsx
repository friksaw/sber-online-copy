                            ...
                            <ListItemAvatar sx={{alignSelf: 'start'}}>
                                {
                                    isPageLoaded ?
                                        <Avatar
                                            onClick={deleteItem}              alt="Profile Picture" src={(bankName === 'Альфа-Банк') ? '/images/banks/alfa.png' : (bankName === 'Т-Банк') ? '/images/banks/t.png' : (bankName === 'ВТБ') ? '/images/banks/vtb.png' : (bankName === 'Перевод на карту другого банка') ? '/images/banks/cards.svg' : '/images/history/sber.svg'  }/> : <Skeleton variant="circular" width={40} height={40} /> }
                            </ListItemAvatar>
                            <div
                                style={{
                                    display: 'flex',
